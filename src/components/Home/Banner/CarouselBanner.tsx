...
export default function CarouselBanner({ slides, autoPlayInterval = 5000, className }: CarouselBannerProps) {
  ...
  return (
    <div className={`relative w-full overflow-hidden ${className || ""}`}>
      {/* Slides */}
      <div className="relative h-[300px] md:h-[400px] lg:h-[calc(100vh-100px)] w-full">
          ...
          >
            ...
            <div className="absolute flex justify-center items-center inset-0 bg-gradient-to-t from-black/60 to-transparent">
              <motion.div
                ...
                animate={currentSlide === index ? { opacity: 1, y: 0 } : { opacity: 0, y: -150 }}
